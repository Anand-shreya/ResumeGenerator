...
import EducationCard from "./Components/Details/EducationCard"; // Dynamic Education section
import SkillsCard from "./Components/Details/SkillCard"; // Dynamic Skill section
import ExperienceCard from "./Components/Details/ExperienceCard"; // Dynamic Experience section
import AchievementsCard from "./Components/Details/AchievementsCard"; // Dynamic Achievements section

import UploadData from "../DataHandler/uploaddata"; // Upload Data entered in form by user
import UploadTemp from "../DataHandler/uploadtemp"; // Upload Custom Template
import Download from "../DataHandler/download"; // Download Generated Resume
